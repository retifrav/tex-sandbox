...
Can be a regular image format such as JPG:
...
\begin{center}
    \includegraphics[width=\columnwidth]{./img/PvalueMovingSample_all.pdf}
\end{center}
...
And suddenly here's \citeyear{einstein1905} again. And if you'll have it again \citeyear{einstein1905}, then you'll get an empty thing, because repeated citation is like that. Fuck knows how to fix that.
